...
@Tag(name="AuthenticationService", description="AuthenticationService with JWT Tokens")
@RequestMapping("/auth")
@RestController
public class AuthenticationController {
    ...
    @PostMapping("/login")
    public ResponseEntity<LoginResponse> authenticate(@RequestBody UserData loginUserDto) {
